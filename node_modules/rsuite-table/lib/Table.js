...
var Table = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  var mouseAreaRef = (0, _react.useRef)();
  var tableRef = (0, _react.useRef)();
  var tableHeaderRef = (0, _react.useRef)();
  var affixHeaderWrapperRef = (0, _react.useRef)();
  var headerWrapperRef = (0, _react.useRef)();
  var tableBodyRef = (0, _react.useRef)();
  var wheelWrapperRef = (0, _react.useRef)();
  var scrollbarXRef = (0, _react.useRef)();
  var scrollbarYRef = (0, _react.useRef)();
  /**
  ...
  var getTableHeight = (0, _react.useCallback)(function () {
    ...
    if (shouldFixedColumn && contentWidth.current > tableWidth.current) {
      ...
      rowNode = /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, fixedLeftCellGroupWidth ? /*#__PURE__*/_react["default"].createElement(_CellGroup["default"], {
        ...
        style: rtl ? {
          ...
          left: tableWidth.current - fixedRightCellGroupWidth - _constants.SCROLLBAR_WIDTH
        },
        height: props.isHeaderRow ? props.headerHeight : props.height,
        width: fixedRightCellGroupWidth + _constants.SCROLLBAR_WIDTH
      }, (0, _utils.mergeCells)((0, _utils.resetLeftForCells)(fixedRightCells, _constants.SCROLLBAR_WIDTH))) : null, shouldRenderExpandedRow && renderRowExpanded(rowData));
    } else {
  ...
  var shouldRenderExpandedRow = (0, _react.useCallback)(function (rowData) {
    return (0, _isFunction["default"])(renderRowExpandedProp) && !isTree && expandedRowKeys.some(function (key) {
...
Table.defaultProps = {
  data: [],
  defaultSortType: _constants.SORT_TYPE.DESC,
  height: 200,
  rowHeight: 46,
  headerHeight: 40,
  minHeight: 0,
