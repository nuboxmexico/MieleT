...
import type { StandardProps, SortType, RowDataType, RowKeyType, TableLocaleType } from './@types/common';
export interface TableProps extends Omit<StandardProps, 'onScroll'> {
     ...
     */
    shouldUpdateScroll?: boolean | ((event: 'bodyHeightChanged' | 'bodyWidthChanged' | 'widthChanged') => {
        x?: number;
        y?: number;
    });
